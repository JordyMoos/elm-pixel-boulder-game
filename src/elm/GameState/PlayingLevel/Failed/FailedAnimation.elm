...
init : Config -> Actor.LevelConfig -> Actor.CanvasImages -> Animation.Model -> String -> Actor.Level -> Model
init config levelConfig images animationModel description level =
    { config = config
